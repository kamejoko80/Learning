...
# Arithmetic is jest syntactic sugar
...
# nil is the only other 'falsey' value
!nil    #= true
!false  #= true
!0      #= false
...
new_hash.keys #= [:defcon, :acion]

# Check existence of keys and values in hash
new_hash.key?(:defcon) #= true
new_hash.value?(3) #= true

# Tip: Both Arrays and Hash are Enumerable
...
#
# The "each" method of a range runs the block once
...
# If you still need an index
# you can use "each_with_index" and define an index variable
...
begin
  ...
  puts 'This run if no exceptions were thrown at all'
ensure
...
# Functions (and all blocks) implicitly return the value of
# the last statement
double(2) #= 4
...
def guests(&block)
  block.call 'some_arguemnt'
end

# You can pass a list of arguments,
# which will be converted into an array
# That's what splat operator ('*') is for
def guests(*array)
  array.each { |guest| puts guest}
end

# If a method returns an array,
...
# By convention, all methods that return booleans end
# with a question mark
5.even? #= false
5.odd? #= true

# And if a method ends with an exclamation mark,
# it does something destructive like mutate the teceiver.
# Many methods have a ! version to make a change,
# and a non-! version to just return a new changed version
...
class Human
  # A class variable.
  # It's shared by all instances of this class.
  @@species = 'H. sapiens'
  ...
  def initialize(name, age = 0)
    ...
    # to the default in the argument
    @age = age
  end
...
# Variable that start with a capital letter are constants
Var = "I'm a constant"
...
## learnxinyminutes-docs/blob/master/ruby.html.markdown
